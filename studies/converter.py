...
"""
# biblioteca para fazer requisições HTTP de forma síncrona (bloqueante)
import requests
...
# função para acessar a API de valores monetarios e faz a conversão do mesmo
def sync_converter(from_currency: str, to_currency: str, price: float):
    ...
    # converte a resposta da API (texto) em um dicionário Python
    data = response.json()
